...
class db_table:
    ...
    def create_tables(cls):
        ...
        cursor.execute("CREATE TABLE IF NOT EXISTS login (login_id INT PRIMARY KEY AUTO_INCREMENT,unv_mail VARCHAR(50) NOT NULL UNIQUE,password VARCHAR(50) NOT NULL,user_id INT NOT NULL,barcode BIGINT NOT NULL UNIQUE,FOREIGN KEY(user_id) REFERENCES user(user_id))")
